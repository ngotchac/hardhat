...
export declare class BlockchainData {
    ...
    getTransaction(transactionHash: Buffer): import("@ethereumjs/tx").Transaction | import("@ethereumjs/tx").AccessListEIP2930Transaction | import("@ethereumjs/tx").FeeMarketEIP1559Transaction | undefined;
