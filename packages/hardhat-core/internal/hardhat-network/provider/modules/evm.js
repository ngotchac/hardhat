...
class EvmModule {
    ...
    _setNextBlockTimestampParams(params) {
        return validation_1.validateParams(params, rpcQuantityOrNumber);
    }
    ...
    async _mineAction(timestamp) {
        ...
        const result = await this._node.mineBlock(true, new ethereumjs_util_1.BN(timestamp));
    ...
    async _snapshotAction() {
        ...
        return base_types_1.numberToRpcQuantity(snapshotId);
    }
    // evm_setAutomine
    ...
    _setIntervalMiningParams(params) {
        return validation_1.validateParams(params, hardhat_network_1.rpcIntervalMining);
    }
